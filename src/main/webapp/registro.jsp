...
<div class="container">
	...
	<form class="p-3">
	  <div class="mb-3">
	    <label for="nombreCliente="form-label">Nombre de Cliente</label>
	    <input type="text" class="form-control" name="nombreCliente">
	  </div>
	  <div class="mb-3">
	    <label for="telefonoCliente" class="form-label">Telefono de Cliente</label>
	    <input type="text" class="form-control" name="telefonoCliente">
	  </div>
	  <div class="mb-3">
	    <label for="direccionCliente" class="form-label">Direccion de Cliente</label>
	  ...
	  <div class="mb-3">
	    ...
	    <select class="form-select" aria-label="Elegir Electrodomestico">
	  ...
	  <div class="mb-3">
	    ...
	    <select class="form-select" aria-label="Elegir Estado del Servicio">
  			<option selected>Selecciona</option>
	  ...
	  <div class="mb-3">
	  	<div class="col-5">
    		<label for="date" class="col-1 col-form-label">Fecha Solicitud</label>
